...
import model.item.objects.Fish;
import model.item.objects.SnowBall;

public class Inventory extends java.lang.Object {
	
	
	private ArrayList<model.item.GameObject> inventory;
	...
	public Inventory (int entityId) {
		this.inventory = new ArrayList<model.item.GameObject>();
	...
	public boolean addObject(model.item.GameObject object) {
