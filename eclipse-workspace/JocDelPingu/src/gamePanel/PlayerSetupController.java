...
public class PlayerSetupController {
    ...
    private void handleStartGame() {
        ...
        for (PlayerInput input : playerInputs) {
            ...
            // ColorPicker always yields a valid color string (length at least 8 for 0xRRGGBBFF format)
            if (!name.isEmpty()) {
    ...
    private static class PlayerInput {
        ...
        PlayerInput(int playerNumber, TextField nameField, PasswordField passwordField, ColorPicker colorPicker, VBox vbox) {
