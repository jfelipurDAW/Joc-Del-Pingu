...
public class BBDDPanel {
	...
	public static void main(String[] args) {
		...
		if (con != null) {
			...
			model.db.BBDD.insert(con, "INSERT INTO ENTITY (ENTITYID, ENTITYTYPE, PLAYERNAME, PLAYERPASSWORD, COLOUR) VALUES (999, 'PLAYER', 'PinguTest', 'SuperPingu1234', 'BLUE')");
			model.db.BBDD.print(con, "SELECT * FROM ENTITY WHERE ENTITYID = 999", columnas);
			
			////////////////////////////////////////////////////////////////////////////////////
			System.out.println("\n--- 2. UPDATE ---");
			model.db.BBDD.update(con, "UPDATE ENTITY SET PLAYERPASSWORD = 'NuevaClave99' WHERE PLAYERNAME = 'PinguTest'");
			model.db.BBDD.print(con, "SELECT * FROM ENTITY WHERE ENTITYID = 999", columnas);
